...
def get_city_moveinout():
    ...
    for row in file:
        if row[0] != 'code':
            ...
            try:
                for t in time_list:
                    # url = 'http://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id={}&type={}&date={}'.format(  code, task_type, t)

                    # print(requests.get(url).text)
                    # url = 'https://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id={}&type={}&date={}'.format(code,task_type,t)

                    # 春运实时
                    url = 'https://huiyan.baidu.com/migration/cityrank.jsonp?dt=city&id={}&type={}&date={}'.format(code,
                                                                                                                   task_type,
                                                                                                                   t)
                    try:
    ...
    for row in file:
        if row[0] != 'code':
            ...
            try:
                ...
                # url = "https://huiyan.baidu.com/migration/historycurve.jsonp?dt=city&id={}&startDate=20200922&endDate=20210118&type={}".format(code, task_type)
