...
# move_in = pd.read_csv("D:\\04python project\\01-爬虫-爬取百度迁徙数据\\qianxi\\ChinaAreaCodes.csv")
# cityName = np.array(move_in["cityName"])
print(len(nodeList))
# print(len(cityName))
# # b中有而a中没有的      非常高效！
# lastCityName = list(set(cityName).difference(set(nodeList)))
# print(lastCityName)
# print(len(lastCityName))
delcityName = ['澳门', '克拉玛依', '白沙黎族自治县', '文昌', '东方', '吴忠', '和田地区', '黄南藏族自治州', '迪庆藏族自治州', '昌江黎族自治县', '乌鲁木齐', '陵水黎族自治县', '阿克苏地区', '保亭黎族苗族自治县', '北屯', '伊犁哈萨克自治州', '五指山', '阿拉善盟', '吉林市', '浙江', '林芝地区', '儋州', '阿拉尔', '吐鲁番地区', '昌都地区', '定安', '克孜勒苏柯尔克孜自治州', '日喀则地区', '哈密地区', '莱芜', '果洛藏族自治州', '山南地区', '毕节地区', '嘉峪关', '玉树藏族自治州', '阿里地区', '琼中黎族苗族自治县', '海口', '那曲地区', '固原', '铁门关', '新疆维吾尔自治区', '阿勒泰地区', '怒江傈僳族自治州', '石嘴山', '万宁', '七台河', '广西壮族自治区', '五家渠', '酒泉', '石河子', '内蒙古自治区', '宁夏回族自治区', '可克达拉', '拉萨', '琼海', '神农架林区', '图木舒克', '昆玉', '乐东黎族自治县', '西藏自治区', '甘南藏族自治州', '三亚', '双河', '昌吉回族自治州', '博尔塔拉蒙古自治州', '大兴安岭地区', '塔城地区', '中卫', '巴音郭楞蒙古自治州', '海东地区', '香港', '银川', '屯昌', '铜仁地区', '澄迈', '喀什地区', '临高', '黄山']
