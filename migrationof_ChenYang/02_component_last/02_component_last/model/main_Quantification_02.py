...
def get_cities_num(net1, net2,n1,n2):
    ...
    net1_dest = net1["city_id_name"].tolist()
    net2_depart = net2["city_name"].tolist()
    net2_dest = net2["city_id_name"].tolist()
    total_cities_nodes = set(net1_depart + net1_dest + net2_depart + net2_dest)


    file = open("D:/workspace/python/test/02_新冠_true/net_data/国庆/city_list/"+name1+"_"+name2+"_nodes_list.txt", "w")
...
def get_single_cities_num(net, name):
    ...
    net1_dest = net["city_id_name"].tolist()
    total_cities_nodes = set(net1_depart + net1_dest )
    file = open("D:/workspace/python/test/02_新冠_true/net_data/国庆/city_list/"+name+"_nodes_list.txt", "w")
...
def read_total_cities(strs):
    """读取每个多层网络中的结点数据"""
    file = open("D:/workspace/python/test/02_新冠_true/net_data/国庆/city_list/"+strs+"_nodes_list.txt", "r")
