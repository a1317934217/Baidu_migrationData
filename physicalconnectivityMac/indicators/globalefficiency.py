...
# 计算全局效率
def globalefficiency(allFilePath, begindata, enddata):
    """
    返回绘制图表的
    X轴：日期
    Y轴：全局效率
    ...
    plt.title('百度迁徙2020-2021全局效率折线图', FontProperties=font)
    ax.plot(listXdata, listGlobalEfficiency)
    plt.show()


# Mac 上跑数据的地址
globalefficiency("/Users/wuhao/百度迁徙数据爬取/物理联通指标所需数据/", 20200101, 20211028)
# win大壳子上跑数据的地址
# globalefficiency("F:\\01大连民族\\百度迁徙爬取和数据\\百度迁徙数据-final\\in\\", 20200101, 20211028)
