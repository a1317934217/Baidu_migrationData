...
# baiduMigrationIndex = pd.read_csv("F:\\01大连民族\百度迁徙爬取和数据\\百度迁徙数据更新_经常运行\\迁徙指数\\in\\120000_天津_move_in.csv",encoding="utf-8")
# migrationIndexDataCol = baiduMigrationIndex.loc[baiduMigrationIndex["date"] == 20211029]
# print(migrationIndexDataCol)
